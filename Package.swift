...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAudioBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAudioBL-1.0.0-beta.20230710170706.xcframework.zip",
			checksum: "794ad7d681a241116c6acdc37914b28b7c3fc88b96d11ab08612b7e9de4a1133"
		)
	]
)