...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAudioBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAudioBL-1.0.0-beta.20230710193719.xcframework.zip",
			checksum: "c6d3929e2b296a98b6dd029c0462b40875acf2f085bdb1f3ca6a4734af8b5031"
		)
	]
)