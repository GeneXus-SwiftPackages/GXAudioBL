...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAudioBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAudioBL-1.0.0-beta.20230704143346.xcframework.zip",
			checksum: "1e91209abb83ee32211b72c6230c0bf34cbaeeb4c2dbd6953a08e81e19df8c6d"
		)
	]
)