...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAudioBL",
			url: "https://pkgs.genexus.dev/iOS/preview/GXAudioBL-1.0.0-preview.20230715000002.xcframework.zip",
			checksum: "7d0a53d921a2dbbceeafee3fcb2561de13cf08dda7ba0088488441bcb062f609"
		)
	]
)