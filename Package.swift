...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAudioBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAudioBL-1.0.0-beta.20230701000831.xcframework.zip",
			checksum: "a362bb6da64232a1aadd73bfbc47da491dab5726c98b9a661aa7a3cc61c5db2f"
		)
	]
)