...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXAudioBL",
			url: "https://pkgs.genexus.dev/iOS/beta/GXAudioBL-1.0.0-beta.20230630152236.xcframework.zip",
			checksum: "0a91c98be17ec489a810b6837a1cd90c46c7bb91fbc019a75dca5da5db6b145b"
		)
	]
)